...
func newGenericTarWrappedJavaArchiveParser(cfg CatalogerConfig) genericTarWrappedJavaArchiveParser {
...
func discoverPkgsFromTar(location file.Location, archivePath, contentPath string, cfg CatalogerConfig) ([]pkg.Package, []artifact.Relationship, error) {
