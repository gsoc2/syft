...
func newGenericArchiveParserAdapter(cfg CatalogerConfig) genericArchiveParserAdapter {
...
func newJavaArchiveParser(reader file.LocationReadCloser, detectNested bool, cfg CatalogerConfig) (*archiveParser, func(), error) {
...
func findPomLicenses(pomProjectObject *parsedPomProject, cfg CatalogerConfig) {
...
func recursivelyFindLicensesFromParentPom(groupID, artifactID, version string, cfg CatalogerConfig) ([]string, error) {
	var licenses []string
...
func discoverPkgsFromZip(location file.Location, archivePath, contentPath string, fileManifest intFile.ZipFileManifest, parentPkg *pkg.Package, cfg CatalogerConfig) ([]pkg.Package, []artifact.Relationship, error) {
...
func discoverPkgsFromOpeners(location file.Location, openers map[string]intFile.Opener, parentPkg *pkg.Package, cfg CatalogerConfig) ([]pkg.Package, []artifact.Relationship, error) {
	var pkgs []pkg.Package
	var relationships []artifact.Relationship
...
func discoverPkgsFromOpener(location file.Location, pathWithinArchive string, archiveOpener intFile.Opener, cfg CatalogerConfig) ([]pkg.Package, []artifact.Relationship, error) {
...
func newPackageFromMavenData(pomProperties pkg.JavaPomProperties, parsedPomProject *parsedPomProject, parentPkg *pkg.Package, location file.Location, cfg CatalogerConfig) *pkg.Package {
